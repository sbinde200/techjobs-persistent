...
public class HomeController {
    ...
    public String processAddJobForm(@ModelAttribute @Valid Job newJob,
        ...
        Optional<Employer> employers = employerRepository.findById(employerId);
        if(employers.isEmpty()) {return "redirect:";}
        Employer employerLandingPad = employers.get();
        newJob.setEmployer(employerLandingPad);
    ...
    public String displayViewJob(Model model, @PathVariable int jobId) {
        ...
        model.addAttribute("job", maybeJob.get());
        return "view";
    }
